...
class PeerSelectionTests(unittest.TestCase):
    def test_veto_rejects_incompatible_auto_peer(self):
        ...
        self.assertEqual([peer.ticker for peer in report.approved], ["GM"])
        ...
        self.assertEqual(report.peer_medians["price_to_earnings"], 7.0)
    ...
    def test_approved_peers_feed_comparable_medians(self):
        ...
        self.assertEqual([peer.ticker for peer in result.peer_selection.approved], ["GM"])
