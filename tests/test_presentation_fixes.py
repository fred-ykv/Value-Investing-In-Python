...
class PresentationFixesTests(unittest.TestCase):
    ...
    def test_markdown_source_values_show_currency_when_available(self):
        markdown = "\n".join(
            [
        ...
        self.assertIn("| cash | USD 35,934,000,000.0000 |", fixed)
    ...
    def test_html_source_values_show_currency_when_available(self):
        html = (
        ...
        self.assertIn("<td>USD 35,934,000,000.0000</td>", fixed)
